                                                        ...
                                                        <td>
                                                            <ul class="list-inline mb-0">
                                                                <li class="list-inline-item">
                                                                    <a href="" class="btn btn-purple waves-effect waves-light"> <i class="fe-edit"></i></a>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <a href="" class="btn btn-danger waves-effect waves-light"> <i class="mdi mdi-delete"></i></a>
                                                                </li>
                                                            </ul>
